...
export class Note {
  ...
  get Template1() {
    return `
        <textarea class="vh-100" cols="99" placeholder="Start taking notes..." onblur="app.notesController.editBody('${this.id}')" type="text" name="body" id="body" value="text" style="height: 50px">${this.body}</textarea>
    `
  }
